...
config :esbuild,
  ...
  default: [
    args:
      ~w(src/index.ts --bundle --target=es2017 --outfile=../priv/static/assets/js/app.js --external:/fonts/* --external:/images/*),
    cd: Path.expand("../assets", __DIR__),
    env: %{"NODE_PATH" => Path.expand("../deps", __DIR__)}
  ]

 config :retrochat, RetrochatWeb.Endpoint, pubsub_server: Retrochat.PubSub

 config :retrochat, version: System.get_env("VERSION", "unknown")
